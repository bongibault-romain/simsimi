...
bot.on('interactionCreate', (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const member = (_a = interaction.guild) === null || _a === void 0 ? void 0 : _a.members.resolve(interaction.member.user.id);
...
bot.on('messageCreate', (message) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (message.reference) {
        const m = fastLearnsMessagesIds.find((mess) => { var _a; return mess.messageId == ((_a = message.reference) === null || _a === void 0 ? void 0 : _a.messageId); });
        if (m) {
            ...
            learn(cleanUp(m.question), cleanUp(message.content), (m) => __awaiter(void 0, void 0, void 0, function* () {
                fastLearnsMessagesIds = fastLearnsMessagesIds.filter((a) => { var _a; return a.messageId != ((_a = message.reference) === null || _a === void 0 ? void 0 : _a.messageId); });
