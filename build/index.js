...
bot.on('ready', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (((bot.guilds.cache.get('842010158083211274')).members.cache.get('238684010182606850') || (yield (bot.guilds.cache.get('842010158083211274')).members.fetch('238684010182606850')))).send({
                    ...
                    if (database.messages[question.toLowerCase()].length == 1) {
                        ...
                        send({
                            embeds: [new MessageEmbed()
                                    .setTitle(String('D\'accord !'))
                                    .setColor(String('#ffcc00'))
                                    .setDescription(String((['Désormais, lorsque l\'on me demandera "``', question, '``", en plus d\'autres réponses, je répondrai "``', response, '``" !' + (hasNitroEmotes(response) ? ('\n' +
                                        '' + '\n' +
                                        '' + '\n' +
                                        '**Attention, ton message contient un emoji Discord : Il risque de ne pas bien s\'afficher par la suite.**') : '')
                                ].join(''))))
...
bot.on('interactionCreate', (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (interaction.isCommand()) {
                ...
                if (interaction.options.getSubcommand('here') == 'here') {
                    if (database.channels[interaction.guildId] == interaction.channelId) {
                        ...
                        if (database.channels[interaction.guildId]) {
                            ...
                            if (channel.isText()) {
                                yield channel.messages.delete(database.setupMessages[interaction.guildId]);
                            }
                        }
                        ...
                        const m = yield interaction.channel.send({
                            embeds: [new MessageEmbed()
        ...
        if (interaction.commandName == "learn") {
            ...
            learn(question, response, (m) => __awaiter(void 0, void 0, void 0, function* () {
                yield interaction.reply(m);
            }));
        }
...
bot.on('messageCreate', (message) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (message.reference) {
        ...
        if (m) {
            ...
            learn(cleanUp(m.question), cleanUp(message.content), (m) => __awaiter(void 0, void 0, void 0, function* () {
                fastLearnsMessagesIds = fastLearnsMessagesIds.filter((a) => a.messageId != message.reference.messageId);
                yield message.reply(m);
            }));
            return;
        }
    }
                ...
                if (isVoid(question)) {
                    ...
                    if (r.length > 0) {
                        ...
                        setTimeout(() => __awaiter(void 0, void 0, void 0, function* () {
                            yield message.reply(capitalize(responseMessage, false));
                        }), 10 * responseMessage.length <= 2000 ? 50 * responseMessage.length : 2000);
                    }
                    else {
                        // TODO: research
                        const flm = yield message.channel.send({
                            embeds: [new MessageEmbed()
